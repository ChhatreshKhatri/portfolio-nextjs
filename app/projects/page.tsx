        ...
        <div className="grid grid-cols-1 w-full gap-1 lg:grid-cols-2 rounded-xl bg-contentBg dark:bg-darked mt-6 p-3 xs:p-6">
          ...
          <div className="flex items-center">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center xs:px-8">
              ...
              <h2 className="text-2xl xxs:text-3xl md:text-4xl xl:text-5xl font-semibold text-center">
                Ramaa Creations
              </h2>
              ...
              <p className="text-xl mt-4 text-justify">
                Built using Alicms tool at Alibaba Cloud Low-Code Development Contest 2022.
              </p>
        ...
        <div className="grid grid-cols-1 w-full gap-1 lg:grid-cols-2 rounded-xl bg-contentBg dark:bg-darked mt-6 p-3 xs:p-6">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center xs:px-8">
              ...
              <h3 className="text-xl  xl:text-3xl font-semibold mt-4 text-center">
                A question-answer website with chatbot feature
              </h3>
              <p className="text-xl mt-4 text-justify">
                A popular online forum for programming-related questions and answers built using MERN Stack, and it
                features user authentication, a voting system for answers, and keyword-based question search.
              </p>
              <div className="mt-8 flex space-x-4 text-xl justify-center">
                <Link
        ...
        <div className="grid grid-cols-1 w-full gap-1 lg:grid-cols-2 rounded-xl bg-contentBg dark:bg-darked mt-6 p-3 xs:p-6">
          ...
          <div className="flex items-center">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center xs:px-8">
              ...
              <h3 className="text-xl  xl:text-3xl font-semibold mt-4 text-center">An e-commerce Jewellery website</h3>
              <p className="text-xl mt-4 text-justify">
                This project includes a range of features including user authentication, a shopping cart, product
                details page, payment processing and order history.
              </p>
              <div className="mt-8 flex space-x-4 text-xl justify-center">
                <Link
        ...
        <div className="grid grid-cols-1 w-full gap-1 lg:grid-cols-2 rounded-xl bg-contentBg dark:bg-darked mt-6 p-3 xs:p-6">
          ...
          <div className="flex items-center  lg:order-2">
            ...
            <div className="w-full h-full flex flex-col justify-center items-center xs:px-8">
              ...
              <p className="text-xl mt-4 text-justify">
                A simple Android chat app allows users to communicate with each other through text messages on their
                Android devices. The app typically features a user-friendly interface and easy-to-use chat functions.
              </p>
              <div className="mt-8 flex space-x-4 text-xl justify-center">
                <Link
