...
export default function About() {
  ...
  return (
    <>
      <section className="relative group rounded-lg w-full text-justify p-3 xs:p-6 xs:px-10 py-6">
      ...
      <section role="button" className="rounded flex items-center justify-center bg-gradient-to-r from-blue1 to-yellow1 p-0.5">
        ...
        {data.sections.map((section, index) => (
          <section key={index} className="relative group rounded-lg w-full p-3">
            <div className="absolute -inset-0 rounded-lg bg-gradient-to-r from-blue2/50 to-green2/50 opacity-20 transition duration-500 group-hover:opacity-50"></div>
            <div  className="relative flex flex-col gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 xs:gap-4">
                {section.skills.map((data, index) => (
                  <article key={index} role="button" title={data.name} className={`items-center justify-center p-0.5 rounded bg-gradient-to-r from-yellow1 to-blue1 dark:from-blue1 dark:to-yellow1`}>
