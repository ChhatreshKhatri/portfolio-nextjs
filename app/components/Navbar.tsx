...
const Navbar = () => {
  ...
  return (
    <nav className={`${navOpen || scrolled ? " bg-navbarBg/60 dark:bg-darker/70 backdrop-blur-md shadow-bottom py-1.5 transition-navBar duration-200 ease-in-out" : "py-2"} w-full flex-col items-center px-3 xs:px-6 md:px-12 lg:px-20 sticky z-10 top-0 hidden xs:flex`}>
