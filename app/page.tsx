...
export default function Home() {
  return (
    <main className="w-full h-full flex flex-col  font-medium px-2 xxs:px-3 xs:px-6 md:px-12 lg:px-20 py-20">
      ...
      <div className="relative group grid grid-cols-1 w-full gap-1 lg:grid-cols-3 mt-4">
        ...
        <div className="relative order-2 lg:order-1 lg:col-span-2 flex justify-end items-center rounded-lg">
          ...
          <div className="w-full h-full flex flex-col justify-center rounded-lg p-3 xs:p-6">
